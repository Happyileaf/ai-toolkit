...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run frontend-harness agent review closeout.")
...
def build_claude_prompt(root: Path, target: dict[str, Any]) -> str:
    return f"""You are reviewing code changes for a frontend-harness QA closeout.

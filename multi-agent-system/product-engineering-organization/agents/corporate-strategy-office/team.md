...
| Orchestrator Agent | 跨团队协同编排与升级决策 | 执行计划、升级决策记录、协作节奏安排 |
...
- 知识库可用性: 开工前须通过 Knowledge Team 确认知识库就绪
...
| 组织运行知识库管理 | [`docs/organization-knowledge-base-management.md`](../../docs/organization-knowledge-base-management.md) | Knowledge Team 知识库服务协议 |

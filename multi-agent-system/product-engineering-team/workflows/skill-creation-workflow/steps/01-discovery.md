...
**Discovery Agent** - 参考: `/Users/apple/Desktop/project/ai-toolkit/multi-agent-system/product-engineering-team/agents/skills-team/discovery-agent.md`
...
4. **提案生成**
   - 产出 Skill 提案文档
   - Schema: `skills/schemas/skill-proposal.schema.json`
